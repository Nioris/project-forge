...
name: game-design
kind: architectural
description: "Game design improvements: core loop, progression, difficulty curve, retention hooks, session length, onboarding, meta-game. Use when game feels flat, boring, too easy/hard, or…"
---
