...
kind: architectural
description: "Architectural foundation для health/wellness apps. Поверх app-data-model + onboarding + subscription добавляет: GDPR Article 9 (special category data), encryption at-rest…"
---
