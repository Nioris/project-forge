...
kind: architectural
description: "Monetization design: ads-first by default (rewarded + interstitial), with IAP as an opt-in second tier ONLY when the user explicitly asks for in-app purchases. Designs WHERE and…"
---
