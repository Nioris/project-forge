...
name: pipeline
kind: architectural
description: "Master orchestrator всего жизненного цикла продукта от анализа до релиза (8 steps включая Step 0 Discovery v4.10). Не делает работу сам — координирует skills (discover → analyze…"
---
