...
name: continue
kind: tactical
description: "Resume work on the project. Reads wiki/_current.md, plan, then _map.md and picks up where we left off. Use when user says \"continue\", \"продолжай\", \"resume\", \"where were we\"…"
---
