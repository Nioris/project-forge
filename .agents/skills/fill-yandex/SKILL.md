...
name: fill-yandex
kind: tactical
description: "Заполнение карточки игры для Яндекс Игр: описание, как играть, категория, теги, ключевые слова, возраст, локализованные JSON на 13 языков, SETUP_GUIDE (лидерборды, IAP, реклама)…"
---
