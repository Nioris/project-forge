...
kind: architectural
description: "Roles + permissions для business/SaaS/multi-tenant apps. RBAC pattern, audit log, ownership rules. Без него refactor permissions на 100+ pages = недели."
---
