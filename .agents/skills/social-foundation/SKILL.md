...
kind: architectural
description: "Architectural foundation для social/community apps. Поверх app-data-model + permissions + onboarding добавляет: content moderation pipeline (auto + human), abuse prevention (rate…"
---
