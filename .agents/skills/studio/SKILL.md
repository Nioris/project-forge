...
name: studio
kind: architectural
description: "Phase-aware AI Studio orchestrator: delegates bounded work to Forge agents, keeps phase gates intact, merges evidence, code, art and QA without skipping the 9-phase pipeline."
---
