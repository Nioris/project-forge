...
name: release-max
kind: tactical
description: "Release pipeline for MAX messenger Mini App (национальный российский мессенджер от VK). Copies to WorkProgress-max, integrates MAX Bridge + wrapper, runs pre-submit, builds…"
---
