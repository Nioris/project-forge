...
kind: tactical
description: "Release pipeline for RuStore Android APK/AAB. Wraps HTML5 in Capacitor, signs, builds release APK/AAB to Release/{project}/rustore/. Use when user says \"release rustore\", \"собери…"
---
