...
name: handoff
kind: tactical
description: "Prepare the project for the next session by crystallising state in wiki/_current.md. Use when context is long, switching tasks, or ending a work session. Triggers on \"handoff\"…"
---
