...
kind: tactical
description: "App notifications: local reminders, push setup, badge counters, in-app notification center, scheduled alerts, toast messages. Use when app needs reminders, alerts, or…"
---
