...
name: autopilot
kind: architectural
description: "Step 4 главного pipeline. AUTONOMOUS mode — Claude идёт по wiki/plan/02-development-plan.md до конца, не отвлекая пользователя. Останавливается ТОЛЬКО на blockers / repeated…"
---
