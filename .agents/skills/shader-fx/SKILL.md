...
name: shader-fx
kind: tactical
description: "Custom GLSL/TSL shaders для Three.js — toon, rim lighting, dissolve, water, hologram, force field, fresnel glow, vertex animation. ShaderMaterial с vertex+fragment shaders."
---
