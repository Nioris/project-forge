...
name: visual-style
kind: tactical
description: "Apply distinctive visual style к Three.js game via post-processing + materials. 16 looks: realistic PBR, toon, low-poly, wireframe, neon, glass, pixel art, voxel, matcap…"
---
