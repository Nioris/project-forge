...
name: art-prompts
kind: tactical
description: "Store/game art prompt planning for icons, covers and promo creatives. In Forge 4.67 it delegates reproducible production prompts to $prompt-compiler and generation to…"
---
