...
name: find-skill
kind: tactical
description: "Discovery skill — помогает юзеру найти подходящий skill когда capability нужна, но юзер не знает что у нас уже есть для этого skill. Также подключается к npx skills marketplace…"
---
