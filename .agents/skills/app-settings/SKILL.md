...
name: app-settings
kind: tactical
description: "App settings: dark/light theme, user preferences, font size, language, data management (export/import/clear), about page, feedback. Use when app needs settings screen or theme…"
---
