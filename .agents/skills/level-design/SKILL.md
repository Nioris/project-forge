...
name: level-design
kind: architectural
description: "Procedural and hand-crafted level design for ALL genres: wave tables, room generators, track layouts, puzzle grids, map builders, boss arenas. Creates level data structures…"
---
