...
name: release-ok
kind: tactical
description: "Release pipeline for Odnoklassniki (OK) Mini App. Integrates FAPI SDK + wrapper, runs pre-submit, builds HTTPS bundle in Release/{project}/ok/. Use when user says \"release ok\"…"
---
