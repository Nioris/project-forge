...
name: release-web
kind: tactical
description: "Release pipeline for web hosting (VPS / Docker / PaaS). Generates Dockerfile + nginx.conf + deploy guide in Release/{project}/web/. Use when user says \"release web\", \"собери под…"
---
