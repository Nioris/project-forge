...
kind: tactical
description: "Check and request all required credentials, API keys, SDK IDs, signing keys before building for any platform. ALWAYS run before $convert, $build-apk, $release-yandex, $deploy."
---
