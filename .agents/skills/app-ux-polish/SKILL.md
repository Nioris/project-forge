...
name: app-ux-polish
kind: tactical
description: "Polish app UX: user flows, empty states, error handling, loading states, confirmations, undo, micro-interactions. Transforms functional-but-raw apps into polished products. Use…"
---
