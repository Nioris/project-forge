...
name: release-steam
kind: tactical
description: "Полный пайплайн публикации HTML5 игры на Steam через Electron + steamworks.js. Phase 0 research + проверка Steamworks Partner account + Electron упаковка + steamworks integration…"
---
