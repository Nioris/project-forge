/**
 * @file _lib.mjs
 * @description Shared helpers for MAX validators. Mirrors shape of
 *              platforms/telegram/validators/_lib.mjs.
 */
...
export function walkFiles(dir, extensions = ['.html', '.js', '.mjs', '.css']) {
  ...
  while (stack.length) {
    ...
    for (const e of entries) {
      ...
      if (e.isDirectory()) {
        if (['node_modules', '.git', '__pycache__', 'dist', 'build'].includes(e.name)) continue;
        stack.push(p);
