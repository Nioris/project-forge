...
**Текущая публичная версия:** `v4.68.14`
...
В `v4.68.14` обычная авторизация и API-профили остаются разделены.
...
- [RELEASE_NOTES_v4.68.14.md](RELEASE_NOTES_v4.68.14.md) — изменения текущей версии
