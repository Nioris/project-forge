...
**Текущая версия исходников:** `v4.68.75`
...
В `v4.68.75` обычная авторизация и API-профили остаются разделены.
...
- [RELEASE_NOTES_v4.68.75.md](RELEASE_NOTES_v4.68.75.md) — изменения текущей версии
