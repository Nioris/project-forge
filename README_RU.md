...
**Текущая версия исходников:** `v4.68.76`
...
В `v4.68.76` обычная авторизация и API-профили остаются разделены.
...
- [RELEASE_NOTES_v4.68.76.md](RELEASE_NOTES_v4.68.76.md) — изменения текущей версии
