...
**Текущая версия исходников:** `v4.68.71`
...
В `v4.68.71` обычная авторизация и API-профили остаются разделены.
...
- [RELEASE_NOTES_v4.68.71.md](RELEASE_NOTES_v4.68.71.md) — изменения текущей версии
