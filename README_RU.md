...
**Текущая публичная версия:** `v4.68.12`
...
В `v4.68.12` обычная авторизация и API-профили остаются разделены.
...
- [RELEASE_NOTES_v4.68.12.md](RELEASE_NOTES_v4.68.12.md) — изменения текущей версии
