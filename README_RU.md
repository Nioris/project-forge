...
**Текущая публичная версия:** `v4.68.51`
...
В `v4.68.51` обычная авторизация и API-профили остаются разделены.
...
- [RELEASE_NOTES_v4.68.51.md](RELEASE_NOTES_v4.68.51.md) — изменения текущей версии
