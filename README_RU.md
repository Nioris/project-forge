...
**Текущая версия исходников:** `v4.68.58`
...
В `v4.68.58` обычная авторизация и API-профили остаются разделены.
...
- [RELEASE_NOTES_v4.68.58.md](RELEASE_NOTES_v4.68.58.md) — изменения текущей версии
