...
**Текущая публичная версия:** `v4.68.54`
...
В `v4.68.54` обычная авторизация и API-профили остаются разделены.
...
- [RELEASE_NOTES_v4.68.54.md](RELEASE_NOTES_v4.68.54.md) — изменения текущей версии
