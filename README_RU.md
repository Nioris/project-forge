...
**Текущая версия исходников:** `v4.68.77`
...
В `v4.68.77` обычная авторизация и API-профили остаются разделены.
...
- [RELEASE_NOTES_v4.68.77.md](RELEASE_NOTES_v4.68.77.md) — изменения текущей версии
