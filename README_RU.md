...
**Текущая публичная версия:** `v4.68.57`
...
В `v4.68.57` обычная авторизация и API-профили остаются разделены.
...
- [RELEASE_NOTES_v4.68.57.md](RELEASE_NOTES_v4.68.57.md) — изменения текущей версии
