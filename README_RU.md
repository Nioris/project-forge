...
**Текущая публичная версия:** `v4.68.1`
...
В `v4.68.1` обычная авторизация и API-профили разделены.
...
- [RELEASE_NOTES_v4.68.1.md](RELEASE_NOTES_v4.68.1.md) — изменения текущей версии
