...
**Текущая публичная версия:** `v4.68.50`
...
В `v4.68.50` обычная авторизация и API-профили остаются разделены.
...
- [RELEASE_NOTES_v4.68.50.md](RELEASE_NOTES_v4.68.50.md) — изменения текущей версии
