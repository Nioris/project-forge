...
**Текущая версия исходников:** `v4.68.78`
...
В `v4.68.78` обычная авторизация и API-профили остаются разделены.
...
- [RELEASE_NOTES_v4.68.78.md](RELEASE_NOTES_v4.68.78.md) — изменения текущей версии
