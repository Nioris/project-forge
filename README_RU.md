...
**Текущая версия исходников:** `v4.68.70`
...
В `v4.68.70` обычная авторизация и API-профили остаются разделены.
...
- [RELEASE_NOTES_v4.68.70.md](RELEASE_NOTES_v4.68.70.md) — изменения текущей версии
