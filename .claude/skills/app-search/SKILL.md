...
name: app-search
kind: architectural
description: "Search functionality для tools/reference apps. Local search (Fuse.js fuzzy / Lunr index), filter/sort, search history, autocomplete. ОБЯЗАТЕЛЬНО для tools/reference apps где search = primary interaction. Triggers on: search, поиск, find, fuzzy search, Fuse, Lunr, autocomplete, filter, sort, tools app search."
---
