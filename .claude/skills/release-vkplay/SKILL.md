...
name: release-vkplay
kind: tactical
description: "Полный пайплайн публикации HTML5 игры на VK Play (vkplay.ru). Phase 0 research + dev account + iframe wrap + JS API + signature verification + payment webhook + публикация. Triggers on: relize VK Play, на vkplay, выпустить vkplay, /release-vkplay, релиз вкплей, vkplay.ru, опубликовать вкплей."
---
