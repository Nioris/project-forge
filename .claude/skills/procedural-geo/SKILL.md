...
name: procedural-geo
kind: tactical
description: "Generate 3D geometry procedurally в code — terrain via simplex noise, low-poly clouds, voxel structures, hex grids, buildings. No asset downloads — geometry is math, keeps zip tiny (critical для Yandex 100MB limit). Triggers on: procedural, процедурная генерация, terrain, ландшафт, generate geometry, noise terrain, voxel world, hex grid, генерация уровня, procedural mesh."
---
