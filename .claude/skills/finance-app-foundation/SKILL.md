...
kind: architectural
description: "Architectural foundation для finance/fintech apps. Поверх app-data-model + permissions добавляет: PCI-DSS compliance hooks, transaction integrity (atomic + audit), decimal arithmetic (NEVER float for money), encryption for account/card data, currency handling, regulatory disclaimers. Триггер: бюджет, инвестиции, банк, кошелёк, кредит-калькулятор, платёжки. Triggers on: finance app, fintech, бюджет, инвестиции, банк, wallet, кредит, expense tracker, PCI compliance, transaction integrity."
---
