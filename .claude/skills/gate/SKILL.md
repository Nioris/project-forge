...
name: gate
kind: tactical
description: Run pre-submit validation gate for the active platform. Auto-detects platform from wiki/_current.md or asks. Use when user says "gate", "проверь", "pre-submit", "проверка готовности", "готово к отправке".
---
