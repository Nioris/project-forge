...
name: 3d-perf
kind: tactical
description: "Optimize Three.js game performance — reduce draw calls below 100, instancing, geometry merging, LOD, texture compression (Draco/KTX2), memory management. Target 60fps on mobile. Triggers on: 3d performance, оптимизация 3д, draw calls, тормозит игра, fps drop, lag, instancing, optimize three.js, lighthouse, медленно работает."
---
