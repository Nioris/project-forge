...
kind: tactical
description: "Maintain the shipped Yandex debug checker, reproduce false verdicts, and verify runtime evidence. Use for debugcheck defects, misleading PASS, timing, input, audio and viewport checks."
---
