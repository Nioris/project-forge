...
kind: architectural
description: "Step 3 главного pipeline. Запускает параллельно специалистов (game-design, level-design, monetization-design, art-prompts, sound-design, architecture review) которые читают metrics.md + research/ и составляют дизайн-документы под целевые метрики. Итог: детальный план разработки для дальнейшей реализации. Triggers on: design pipeline, дизайн команда, gdd, design document, art document, план разработки, give to designers, передать в дизайн."
---
