...
name: mobile-ready
kind: tactical
description: "Audit HTML5 project for mobile readiness: touch controls, responsive UI, orientation, performance. If not ready — fix before wrapping. Triggers on: mobile, touch, controls, responsive, orientation, audit, ready."
---
