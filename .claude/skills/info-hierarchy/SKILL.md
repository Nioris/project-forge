...
name: info-hierarchy
kind: architectural
description: "Information hierarchy designer — определяет primary/secondary/tertiary tier для каждого экрана ДО вёрстки. Без этого все элементы кричат одновременно (как Самогонщик: статы кассы, ивенты, helpers — всё одинаково prominent). Output — hierarchy spec для каждого screen с tier-mapping и 3-second test. Triggers on: hierarchy, иерархия, primary/secondary, что главное, всё кричит, плоский UI, невозможно сканировать, focal point, фокусная точка, eye flow, scanning, что важнее."
---
