...
name: app-data-flow
kind: tactical
description: "App data management: search, filter, sort, pagination, virtual scroll, categories, tags, statistics/analytics dashboards. Makes data-heavy apps fast and navigable. Use when app has lists, catalogs, histories, or any data collection. Triggers on: search, поиск, filter, фильтр, sort, сортировка, categories, tags, pagination, статистика, analytics, dashboard."
---
