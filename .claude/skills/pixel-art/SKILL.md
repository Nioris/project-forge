...
name: pixel-art
kind: tactical
description: "Make GOOD pixel-art sprites the first time: limited-palette ramps, readable silhouettes, animation frames (idle/walk/attack/hit), sprite-sheet layout, integer-scale crisp rendering. Code-drawn (canvas) — zero asset downloads, tiny zip. Fixes pixel art coming out as flat detail-less blobs with no animation. Run /art-direction first. Triggers on: pixel art, пиксель арт, пиксельная графика, sprite, спрайт, sprite sheet, спрайт лист, animation frames, idle walk attack, 8-bit, 16-bit, retro sprite, тайлсет, tileset."
---
