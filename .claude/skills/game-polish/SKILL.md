...
name: game-polish
kind: tactical
description: "Pre-release game polish: what to improve before Yandex moderation, priority fixes, quality bar, production checklist. Covers onboarding, first-time experience, visual polish, audio, performance. Triggers on: polish, improve, quality, fix, moderation, reject, better, professional, ugly, boring."
---
