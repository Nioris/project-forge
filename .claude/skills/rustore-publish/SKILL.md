...
kind: tactical
description: "Prepare for RuStore: listing, keystore, AAB, API key, server receipt validation, IAP, moderation — full pipeline. Also ships anonymous auth + E2E cloud sync pattern (AUTH-SYNC.md) and Review SDK integration. Trigger on: 'rustore publish', 'публикация rustore', 'rustore release', 'android рустор'."
---
