...
kind: tactical
description: "Deep integration VK Play JS API: payments (openPaymentDialog + webhook), auth (uid+hash signing), share, leaderboards через HTTP API, achievements через HTTP, iframe resize, locale detection. Triggers on: vkplay sdk, vkplay payments, vkplay leaderboard, vkplay achievements, /vkplay-sdk-integration."
---
