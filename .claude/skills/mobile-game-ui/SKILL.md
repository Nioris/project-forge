...
name: mobile-game-ui
kind: tactical
description: "Mobile game UI/UX adaptation: HUD layout, collapsible menus, radial wheels, minimap placement, modal panels, responsive scaling. Fixes: buttons overload, minimap under thumbs, windows not fitting, no adaptive grouping. Triggers on: UI, UX, HUD, minimap, buttons, menu, panel, window, mobile UI, screen space."
---
