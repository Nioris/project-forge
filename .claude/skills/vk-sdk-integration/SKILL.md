...
kind: tactical
description: "VK Bridge integration for Mini Apps: init, lifecycle, launch params, ads (VKWebAppShowNativeAds/CheckNativeAds/Banner), VK Storage (4KB limits), VK Pay голоса (VKWebAppShowOrderBox), leaderboards, VK API calls, dev-mode fallback. Complete checklist-driven integration for HTML5 games and apps. Triggers on: vk bridge, vk sdk, vk mini app, вк мост, vkwebapp, reward, interstitial, order box, vk pay, голоса, storage, leaderboard, launch params, sign."
---
