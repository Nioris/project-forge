...
name: release-vk
kind: tactical
description: Release pipeline for VK Mini Apps. Copies to WorkProgress, integrates VK Bridge, runs verify-vk, builds deployable bundle to Release/{project}/vk/. Use when user says "release vk", "собери под вк", "vk-release", "vk mini app".
---
