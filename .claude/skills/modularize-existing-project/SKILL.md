...
kind: architectural
description: "Safely decompose an existing monolithic web game/app before feature work. Use when an HTML/JS/CSS entrypoint is over 32 KB, over 800 lines, repeatedly exhausts model context, or a targeted edit risks whole-file reconstruction. Produces ordered modules, machine-readable contracts, backup evidence, and regression gates."
---
