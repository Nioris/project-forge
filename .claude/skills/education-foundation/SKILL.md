...
kind: architectural
description: "Architectural foundation для education/learning apps. Поверх app-data-model + onboarding + subscription добавляет: pedagogy framework (Bloom's taxonomy, scaffolding), spaced repetition algorithm (SM-2/Anki-style), progression curve design, COPPA compliance если детям, учительский режим (teacher dashboard), assessment integrity, content versioning. Triggers on: education app, learning, курсы, словарь, упражнения, exam prep, обучение, скиллы, COPPA, child safety, spaced repetition, Anki, flashcards, quiz, lessons, pedagogy."
---
