...
name: phase-7-test
kind: architectural
description: "Фаза 7 — тест: проходит ВСЮ фазу конвейера одной командой, вызывая под-скилы по порядку с их гейтами и stop-points. Triggers on: фаза 7, phase 7, тестовая фаза, протестировать перед релизом."
contract_version: 1
phases:
  - 7
modes:
