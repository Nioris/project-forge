...
name: image-studio
kind: architectural
description: "Generate and edit real game/store images through the current host native image tool first, with direct OpenAI GPT Image 2 or GigaChat text2image backends for reproducible batch work; preserves prompt packs, provenance, references and art-director review. Triggers on: image studio, сгенерируй картинку, нарисуй, sprite, background, icon, cover, imagegen, gpt image."
---
