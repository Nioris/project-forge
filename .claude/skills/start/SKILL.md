...
name: start
kind: architectural
description: Bootstrap a new project from a plain-language description. Use when user says "start", "create project", "new project", "build me", "сделай", "создай проект", or describes an idea to build.
---

# Start New Project

## Arguments
`$ARGUMENTS` — what the user wants to build. Any language.
...
Invoke `/research-references` with the project topic extracted from `$ARGUMENTS`. Examples:
