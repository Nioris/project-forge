...
kind: tactical
description: Release pipeline for Telegram Mini App. Integrates telegram-web-app.js + wrapper, runs pre-submit, builds HTTPS-ready bundle + BotFather manifest in Release/{project}/telegram/. Use when user says "release telegram", "собери под telegram", "telegram mini app", "bot web app".
---
