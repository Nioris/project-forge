...
name: mobile-adapt
kind: tactical
description: "Adapt desktop games to mobile: auto-detect genre, choose orientation (portrait/landscape), map keyboard/mouse controls to touch. Covers ALL genres: shooters (top-down/FPS/TPS), racing, arcade, platformer, strategy, puzzle, fighting, idle, runner, rhythm. Triggers on: mobile, touch, adapt, port, controls, joystick, portrait, landscape, desktop to mobile."
---
