...
name: forge-metrics
kind: tactical
description: "Collect truthful Project Forge delivery metrics per release and across a portfolio: time-to-release, AI cost, repair cycles, pre-release defects, moderation pass rate and workflow automation. Triggers on: forge metrics, product telemetry, стоимость релиза, time to release, repair cycles, defects before release, moderation pass rate, измерить Forge."
contract_version: 1
phases:
  - 8
  - 9
