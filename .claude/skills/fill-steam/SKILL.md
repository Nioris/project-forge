...
name: fill-steam
kind: tactical
description: "Заполнение Steam Store page: description (short + long), 5+ скриншотов 1280x720+, trailer, tags ≤10, system requirements, pricing per-region. Создаёт StoreData/steam/ с готовыми текстами и checklist для Partner panel. Triggers on: заполнить стим, store page steam, описание стим, теги стим, /fill-steam."
---
