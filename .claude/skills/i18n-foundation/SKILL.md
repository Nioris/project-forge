...
kind: architectural
description: "Заложи i18n архитектуру С НУЛЯ — даже если игра/приложение пока на одном русском. Создаёт src/i18n/ structure (ru + en placeholder), t()/td() API, language detection, hot-swap, gate против inline strings. БЕЗ этого retrofit i18n стоит дни. Triggers on: i18n, локализация structure, язык переключение, заложить i18n, многоязычность, inline strings, t function."
---
