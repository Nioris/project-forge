...
name: new-project
kind: architectural
description: Create a new isolated project workspace using git worktrees. Use when user says "new project", "новый проект", "create workspace", "ещё один проект", or wants to work on multiple projects simultaneously without interference.
---
