...
name: new-project
kind: architectural
description: Create a new isolated Project Forge project with its own local Git repository, managed runtime and explicit engine profile. Use when user says "new project", "новый проект", "create workspace", "ещё один проект", or chooses Web/Godot for a new game.
---
