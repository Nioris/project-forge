...
name: polish-app
kind: tactical
description: "Full app polish pipeline — UX, data flows, notifications, settings, theming. Makes functional apps feel like premium products. Use when user says 'polish', 'доведи до ума', 'сделай как надо', 'polish app', 'функционал', 'отполируй', 'make it professional', 'доработай приложение'."
---
...
## Arguments
`$ARGUMENTS`: app folder path (or empty = current project)
