...
**Current public version:** `v4.68.12`
...
`v4.68.12` keeps separate normal-account and API profiles.
...
- [RELEASE_NOTES_v4.68.12.md](RELEASE_NOTES_v4.68.12.md) — current release notes
