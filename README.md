...
**Current source version:** `v4.68.66`
...
`v4.68.66` keeps separate normal-account and API profiles.
...
- [RELEASE_NOTES_v4.68.59.md](RELEASE_NOTES_v4.68.59.md) — current release notes
