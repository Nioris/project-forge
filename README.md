...
**Current source version:** `v4.68.76`
...
`v4.68.76` keeps separate normal-account and API profiles.
...
- [RELEASE_NOTES_v4.68.76.md](RELEASE_NOTES_v4.68.76.md) — current release notes
