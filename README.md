...
**Current public version:** `v4.68.57`
...
`v4.68.57` keeps separate normal-account and API profiles.
...
- [RELEASE_NOTES_v4.68.57.md](RELEASE_NOTES_v4.68.57.md) — current release notes
