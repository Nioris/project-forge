...
**Current source version:** `v4.68.77`
...
`v4.68.77` keeps separate normal-account and API profiles.
...
- [RELEASE_NOTES_v4.68.77.md](RELEASE_NOTES_v4.68.77.md) — current release notes
