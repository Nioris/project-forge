...
**Current public version:** `v4.68.49`
...
`v4.68.49` keeps separate normal-account and API profiles.
...
- [RELEASE_NOTES_v4.68.49.md](RELEASE_NOTES_v4.68.49.md) — current release notes
