...
**Current source version:** `v4.68.78`
...
`v4.68.78` keeps separate normal-account and API profiles.
...
- [RELEASE_NOTES_v4.68.78.md](RELEASE_NOTES_v4.68.78.md) — current release notes
